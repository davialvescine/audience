-- Reduz max do comentário de 280 → 150 caracteres no RPC submit_comment.
-- Cards rotativos com texto curto ficam mais legíveis no telão.
-- Cards existentes maiores que 150 continuam no banco — só novos
-- envios são validados.
