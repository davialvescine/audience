              ...
              >
                <Card className="h-full transition hover:shadow-md hover:border-primary/30">
                  <div className="flex items-start justify-between gap-3 mb-3">
                    ...
                    {isOnline ? (
                      <span className="inline-flex items-center gap-1 text-xs font-medium text-success bg-success/10 px-2 py-1 rounded-sm whitespace-nowrap">
                        <span className="h-2 w-2 rounded-full bg-success animate-pulse" />
                        Ao vivo
                      </span>
                    ) : e.h2r_paired_at ? (
                      <span className="text-xs text-danger bg-danger/10 px-2 py-1 rounded-sm whitespace-nowrap">
                        Offline
                      </span>
                    ) : (
                      <span className="text-xs text-ink/50 bg-surface px-2 py-1 rounded-sm whitespace-nowrap">
                        Não conectado
                      </span>
                    )}
                  </div>
