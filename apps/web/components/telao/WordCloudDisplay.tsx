          ...
          >
            <div className="text-center">
              <p
                ...
                style={{ color: lightBg ? 'rgba(10,37,64,0.7)' : (config.background?.type === 'none' || !config.background ? 'rgba(10,37,64,0.7)' : 'rgba(255,255,255,0.85)') }}
              >
                Aponte a câmera do celular
              </p>
              <p
                className="text-2xl"
                style={{ color: lightBg ? 'rgba(10,37,64,0.55)' : (config.background?.type === 'none' || !config.background ? 'rgba(10,37,64,0.55)' : 'rgba(255,255,255,0.65)') }}
              >e participe agora</p>
            </div>
