...
describe('WordcloudTab', () => {
  it('renders the toggle with initial off state', () => {
    render(<WordcloudTab eventId="evt-1" initialActive={false} initialConfig={baseConfig} publicUrl="http://x/e/evt" telaoUrl="http://x/telao/evt" slug="evt" />);
  ...
  it('shows the active banner when active=true', () => {
    render(<WordcloudTab eventId="evt-1" initialActive={true} initialConfig={baseConfig} publicUrl="http://x/e/evt" telaoUrl="http://x/telao/evt" slug="evt" />);
